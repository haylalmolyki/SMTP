...
def smtp_client(port=1025, mailserver='127.0.0.1'):
    ...
    # Send HELO command and print the server response.
    ...
    # Send MAIL FROM command and handle the server response.
    # Fill in start
    ...
    # Send RCPT TO command and handle the server response.
    # Fill in start
    ...
    # Send DATA command and handle the server response.
    # Fill in start
    dataCommand = 'DATA\r\n'
    ...
    # Message ends with a single period, send the message end and handle the server response.
    # Fill in start
    ...
    # Send QUIT command and handle the server response.
    # Fill in start
    quitCommand = 'QUIT\r\n'
